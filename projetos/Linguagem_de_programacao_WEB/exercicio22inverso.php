...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Exercício 22 inverso</title>
    </head>
    <body>
        <h3>Exercício 22 Ordem Inversa</h3>
        ...
        <br>
        <form action="exercicio22inverso.php" method="post">
            ...
            if(isset($_POST['btn'])){
                if(empty($_POST['nome']) || empty($_POST['fone']) || empty($_POST['end']) || empty($_POST['idade']) || empty($_POST['merda'])){
                    ...
                    if(strlen($_POST['nome'])>10 || strlen($_POST['fone'])>10 || strlen($_POST['end'])>10 || strlen($_POST['idade'])>10 || strlen($_POST['merda'])>10){
                        ...
                        /*
                        $arreverse = array_reverse($ar);

                        $arimplode = implode('<br> -->', $arreverse);
                        echo $arimplode;
                         * 
                         */
                        echo "<ul>";
