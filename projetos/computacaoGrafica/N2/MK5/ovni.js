...
Ovni.prototype = {
	//Faz atualização dos ovnis na tela, excluindo quem não devia estar lá
   atualizar: function() {
   ...
   //Desenha na tela os ovnis
   desenhar: function() {
      var ctx = this.context;
      var img = this.imagem;
      ctx.drawImage(img, this.x, this.y, img.width, img.height);
   },
   //Delimita as dimensões dos ovnis, para as colisões
   ...
   //Faz as colisões e seus processos
